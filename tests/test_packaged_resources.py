...
def test_sql_schema_is_packaged_resource_and_valid():
    ...
    assert {"jobs", "coalesced_notifications", "state", "worklog", "feedback_events", "feedback_rules", "feedback_rule_proposals"} <= tables
...
def test_packaged_resource_names_are_documented():
    ...
    assert {"base.md", "worktree.md", "pr_metadata.md", "human_reviewer.md", "review_only.md", "sync_after_merge.md"} <= prompt_names
